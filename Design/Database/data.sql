...
INSERT INTO `products` (`id`, `name`, `slug`, `description`, `price`, `image1`, `image2`, `category`, `hasEdition`, `edition`, `stock`, `isNew`, `rawInfo`) VALUES
(1, 'The last of us part II', 'the-last-of-us-part-ii', 'The Last of Us Part II es la secuela del juego de zombies postapocalíptico The Last of Us.', '205000', 'last-of-us-detail.png', 'tlou2.png', 18, 1, 'Standard;205000, Coleccionista;350000, Game of the year;250000', 10, 1, NULL),
(2, 'PS4 Pro', 'consola-ps4-pro', 'Ps4 Pro 1tb + Juego Fisico Spiderman. Nuevo y sellado. Garantia de 1 año. Control, Cable HDMI, 4K. Nueva y Sellada.', '2199000', 'ps4.jpg', 'ps4.jpg', 7, 1, 'Standard;2199000', 10, 1, NULL),
...
(4, 'Alienware M15', 'alienware-m15', 'Dell Alienware M15 I7 10ma 16b 512ssd Rtx2070 8gb', '9599000', 'alienware.jpg', 'alienware.jpg', 31, 0, NULL, 2, 1, NULL),
...
(6, 'Monitor Curvo', 'monitor-curvo', 'Monitor curvo Samsung full HD 4K', '1200000', 'curved-monitor.png', 'curved-monitor.png', 38, 0, NULL, 10, 1, NULL),
...
(11, 'Silla gamer tronos', 'silla-gamer-tronos', 'Silla gamer comfortable y ergonómica', '1500000', 'silla_gamer_tronos.jpg', 'silla_gamer_tronos.jpg', 36, 0, NULL, 1, 1, NULL),
(12, 'crash bandicoot 4', 'crash-bandicoot-4', 'LOS RETORCIDOS VILLANOS NEO CORTEX Y EL DR. N. TROPY POR FIN HAN ESCAPADO DE LA PRISIÓN INTERDIMENSIONAL Y HAN DEJADO UN AGUJERO DEL TAMAÑO DE UN CIENTÍFICO MALVADO EN EL UNIVERSO. AHORA, SU PLAN NO SOLO RESIDE EN CONQUISTAR ESTA DIMENSIÓN, QUIEREN CONQUISTARLAS TODAS, Y DEPENDE DE CRASH Y COCO QUE ESO NO OCURRA. LA PLAYA N. SANITY ES DONDE COMIENZA LA AVENTURA DE CRASH Y DONDE LA RETOMAMOS EN CRASH 4, PERO LAS COSAS HAN CAMBIADO DESDE LA PRIMERA VEZ QUE LA VIMOS HACE TANTOS AÑOS. EN CRASH 4, VERÉIS ESOS CAMBIOS EN EL JUEGO, Y PODRÉIS APRECIAR NUESTRO ESTILO ARTÍSTICO', '184000', 'crash4.png', 'crash4-portada.jpg', 18, 0, NULL, 2, 1, 1),
(13, 'Forza Horizon 4', 'forza-horizon-4', 'Forza Horizon 4 - Xbox One', '264012', 'forza horizon.jpg', 'forza horizon portada.jpg', 24, 0, NULL, 12, 1, 2),
(14, 'Forza Horizon 4', 'forza-horizon-4', 'Forza Horizon 4 Nuevo', '45345', 'forza horizon.jpg', 'forza horizon portada.jpg', 22, 0, NULL, 43, 1, 3),
(15, 'Forza Horizon 4', 'forza-horizon-4', 'Forza horizon 4 nuevo neuvco', '323213', 'forza horizon portada.jpg', 'forza horizon.jpg', 23, 0, NULL, 1, 1, 4),
(16, 'Shadow of the Tomb Raider', 'shadow-of-the-tomb-raider', 'Shadow of the tomb raider', '190000', 'tomb raider 1.jpg', 'tomb raider 2.jfif', 18, 0, NULL, 2, 1, 5);
